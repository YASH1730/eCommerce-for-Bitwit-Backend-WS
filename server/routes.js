...
const customer = require("./controller/site/customer");
const categories = require("./controller/accessories/categories");
const products = require("./controller/product/product");
const mergeProduct = require("./controller/product/mergeProduct");
const banner = require("./controller/site/banner");
const order = require("./controller/order/order");
const subCategories = require("./controller/accessories/subCategories");
const primaryMaterial = require("./controller/accessories/primaryMaterial");
const secondaryMaterial = require("./controller/accessories/secondaryMaterial");
const polish = require("./controller/accessories/polish");
const hinge = require("./controller/accessories/hinge");
const fitting = require("./controller/accessories/fitting");
const knob = require("./controller/accessories/knob");
const Supplier = require("./controller/inventory/supplier");
const Handle = require("./controller/accessories/handle");
const Gallery = require("./controller/accessories/gallery");
const blog = require("./controller/site/blog");
const hardware = require("./controller/product/hardware");
const draft = require("./controller/draft/draft");
const fabric = require("./controller/accessories/fabric");
const textile = require("./controller/accessories/textile");
const stock = require("./controller/inventory/stock");
...
route.get("/getLinkedProduct", products.getLinkedProduct);

route.post("/unlinkFromVariations", upload, products.unlinkFromVariations);

route.post("/linkToVariations", upload, products.linkToVariations);
